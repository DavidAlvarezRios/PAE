...
void main(void)
{
    ...
    if (estado_anterior != estado)          // Dependiendo del valor del estado se encender� un LED u otro.
    {
        ...
        sprintf(cadena, "Hora: %02d:%02d:%02d", hora, min, seg );
        escribir(cadena, linea+2);
        ...
        ***********************************************************/
        ...
        case Jstick_Up:
            ...
            if(modo_robot == 0){
                ...
                if(velocitat < 1000){
                    velocitat++; //Augmentem la velocitat dels LEDs
                }

                if(retraso < 10000000000){ // En este caso augmentaremos la variable retraso, eso s� fijando un maximo.
                      retraso += 250;
                      retras_sumat += 0.25;
                }
        ...
        case Jstick_Down:
            ...
            if(modo_robot == 0){
                velocitat--;//Disminuim la velocitat dels LEDs
                ApagarRGB_Launchpad();
